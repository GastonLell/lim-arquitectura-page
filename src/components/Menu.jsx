    ...
    <Navbar id="menu" className="border-bottom px-md-4 px-lg-5" bg="" expand="md">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto flex-grow-1 justify-content-end">
          ...
          <Nav.Link className="px-md-3 px-lg-5 nav__bordeDer" href="#nosotros">NOSOTROS</Nav.Link>
          <Nav.Link className="px-md-3 px-lg-5 nav__bordeDer" href="#proyectos">PROYECTOS</Nav.Link>
          <Nav.Link className="px-md-3 px-lg-5 nav__bordeDer" href="#servicios">SERVICIOS</Nav.Link>
          <Nav.Link className="px-md-3 px-lg-5" href="#contacto">CONTACTO</Nav.Link>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  );
